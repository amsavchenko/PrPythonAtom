...
string = ''
f = open(os.path.expanduser('~/Documents/atom/new_better_descriptions.txt'), 'r')
string += f.read()
f.close()
...
descr_vectors = np.load(os.path.expanduser('~/Documents/atom/vectors.npy'))
calculated_vectors = np.load(os.path.expanduser('~/Documents/atom/plot_vectors.npy'))
